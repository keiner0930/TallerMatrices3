...
public class Helper {
    ...
    public static String recorridoUno(JTable tabla) {
        ...
        aux = aux + Helper.recorridoHaciaAbajo(m, nc - 1, 1, nf / 2 - 1);
        aux = aux + Helper.recorridoHaciaIzquierda(m, nf / 2);
        aux = aux + Helper.recorridoHaciaAbajo(m, 0, nf / 2 + 1, nf - 2);
        aux = aux + Helper.recorridoHaciaDerecha(m, nc - 1);
    ...
    public static String recorridoDos(JTable tabla) {
        ...
        aux = aux + Helper.recorridoHaciaDerecha(m, 0, 1, nc / 2 - 1);
        aux = aux + Helper.recorridoHaciaAbajo(m, nc / 2);
        aux = aux + Helper.recorridoHaciaDerecha(m, nf - 1, nc / 2 + 1, nc - 2);
    ...
    public static String recorridoTres(JTable tabla) {
        ...
        aux = aux + Helper.recorridoHaciaDerecha(m, nf/2-1, nc/2-1, nc/2);
        aux = aux + Helper.recorridoHaciaIzquierda(m, nf/2, nc/2, nc/2-2);
        aux = aux + Helper.recorridoHaciaArriba(m, nc/2-2, nf/2-1, nf/2-2);
        aux = aux + Helper.recorridoHaciaDerecha(m, nf/2-2, nc/2-1, nc/2+1);
        aux = aux + Helper.recorridoHaciaAbajo(m, nc/2+1, nf/2-1, nf/2+1);
        aux = aux + Helper.recorridoHaciaIzquierda(m, nf/2+1, nc/2, nc/2-3);
        aux = aux + Helper.recorridoHaciaArriba(m, nc/2-3, nc/2, nc/2-3);
        aux = aux + Helper.recorridoHaciaDerecha(m, nf/2-3, nc/2-2, nc/2+2);
    ...
    public static String recorridoCuatro(JTable tabla) {
        ...
        aux = aux + Helper.recorridoHaciaDerecha(m, 0);
        aux = aux + Helper.recorridoDiagonalSecundariaAbajo(m, 1,nf-2);
        aux = aux + Helper.recorridoHaciaDerecha(m, nf - 1);
 ...
 public static String recorridoCinco(JTable tabla) {
        ...
        aux = aux + Helper.recorridoDiagonalSecundariaArriba(m,nf/2-1,1);
        aux = aux + Helper.recorridoHaciaAbajo(m, nc-1);
